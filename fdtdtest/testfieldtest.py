...
class MeshnodefieldTest(unittest.TestCase):
    ...
    @patch.object(Meshnodefield, '_Meshnodefield__update_magnetic_field_single_node')
    ...
    @patch.object(Meshnodefield, '_Meshnodefield__update_electric_field_single_node')
    ...
    def test_update_magnetic_field_single_node(self):
        self.__initiate_meshnodefield_variable()
        result = self.meshnodefield._Meshnodefield__update_magnetic_field_single_node(1)
    ...
    def test_update_electric_field_single_node(self, mock_get_relative_permittivity):
        ...
        result = self.meshnodefield._Meshnodefield__update_electric_field_single_node(1)
        self.assertEquals(2 + 1*self.meshnodefield.updatecoefficient, result)
    ...
    def test_update_electric_field_single_node_call_get_relative_permittivity_function(self,
        ...
        self.__initiate_meshnodefield_variable()
        mock_get_relative_permittivity.return_value = 1
        self.meshnodefield._Meshnodefield__update_electric_field_single_node(1)
    ...
    def test_get_relative_permittivity(self):
        ...
        result = self.meshnodefield._Meshnodefield__get_relative_permittivity(1)
